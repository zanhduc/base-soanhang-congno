...
export default function FloatingMenu({ currentPath, onNavigate }) {
  ...
  return (
    <>
      <div id="mega-menu-container" className="fixed top-4 right-4 z-[9000] flex flex-col items-end md:hidden">
        <button
          onClick={(e) => {
            e.stopPropagation()
            setIsOpen(!isOpen)
        ...
        >
          <div className="p-3 border-b border-slate-100 space-y-2.5">
            ...
            <span className="inline-block px-2 py-0.5 text-[10px] font-bold text-rose-800 bg-rose-100 rounded-full uppercase tracking-wider">{user.role}</span>
          </div>
